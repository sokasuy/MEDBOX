        ...
        Try
            If (dgvView.RowCount > 0) Then
                ...
                ElseIf (e.ColumnIndex = dgvView.Columns("edit").Index) Then
                    ...
                    tbNamaKaryawan.Text = karyawan.nama
                    'Komponen Gaji
                    If Not IsDBNull(dgvView.CurrentRow.Cells("komponen_gaji").Value) Then
                        For i As Integer = 0 To cboKomponenGaji.Items.Count - 1
                            If (DirectCast(cboKomponenGaji.Items(i), DataRowView).Item("keterangan") = dgvView.CurrentRow.Cells("komponen_gaji").Value) Then
                                cboKomponenGaji.SelectedIndex = i
                                arrDefValues(1) = dgvView.CurrentRow.Cells("komponen_gaji").Value
                            End If
                        Next
                    End If
                    'Keterangan
