Public Class FormAttachmentDokumen
    ...
    Public Sub New(_dbType As String, _schemaTmp As String, _schemaHRD As String, _connMain As Object, _username As String, _superuser As Boolean, _dtTableUserRights As DataTable, _addNewValues As String, _addNewFields As String, _addUpdateString As String, _groupData As String, _jenis As String, _nomer As String, Optional _nip As String = "xxx", Optional _tanggal As String = "01-Jan-0001")
        Try
    ...
    Private Sub FormAttachmentDokumen_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            ...
            tableName = CONN_.schemaHRD & ".attachmentdokumen"

            isDataPrepared = True

            Dim pathFileSetting As String
            pathFileSetting = Application.StartupPath & "\SETTING.ini"
            fileAttachment.direktori = myCFileIO.ReadIniFile("PROGRAM_INFO", "DOC_ATTACHMENT", pathFileSetting)

            If (dokumen.jenis = "IJIN ABSEN") Then
                strTujuanFile = fileAttachment.direktori & "\" & dokumen.jenis & "\" & "\" & tanggal & "\" & nip & "\" & "\" & dokumen.nomer & "\"
                tbLokasiTujuanFile.Text = strTujuanFile
            Else
                strTujuanFile = fileAttachment.direktori & "\" & dokumen.jenis & "\" & dokumen.nomer & "\"
                tbLokasiTujuanFile.Text = strTujuanFile
            End If
    ...
    Private Sub SetDGV(myConn As Object, myComm As Object, myReader As Object, offSet As Integer, ByRef myDataTable As DataTable, ByRef myBindingTable As BindingSource, mKriteria As String, Optional gantiKriteria As Boolean = False)
        Try
            ...
            stSQL = "SELECT rid,jenisdokumen as jenis_dokumen,nodokumen as no_dokumen,keterangan,pathtofile as path_to_file,namafile as nama_file,groupdata as group_data,ispublic as is_public,created_at,updated_at " &
                    "FROM ( " &
                        "SELECT sub.rid,sub.jenisdokumen,sub.nodokumen,sub.groupdata,sub.ispublic,sub.keterangan,sub.pathtofile,sub.namafile,sub.created_at,sub.updated_at " &
                        "FROM ( " &
                            "SELECT tbl.rid,tbl.jenisdokumen,tbl.nodokumen,tbl.groupdata,tbl.ispublic,tbl.keterangan,tbl.pathtofile,tbl.namafile,tbl.created_at,tbl.updated_at " &
            ...
            With dgvView
                ...
                .Columns("jenis_dokumen").Frozen = True
                .Columns("no_dokumen").Frozen = True
